...
class UserInfo_Airtable_Repo {
   ...
   suspend fun updateOfferHistory(userData: userData ,offerId: String , offerPrice:String , offerName : String) = withContext(Dispatchers.IO){
       ...
       val offerHistory =  OfferHistoryRecord(`in`.oncash.oncash.DataType.SerializedDataType.OfferHistory.Fields(userData.userRecordId , offerId ,  "Being Reviewed" , offerPrice ,offerName ))
